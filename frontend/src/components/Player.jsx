...
const Player = () => {
  ...
  const { song, setSong, currentSong, setCurrentSong, isPlay, setPlay, artists, titleSong, imgPlayer, isShow, setShow, audioIndex, setAudioIndex, listRender } = useContext(SongContext)
    ...
    return (
      <div className={`player ${isShow ? 'show' : ''}`}>
        ...
        <div className="player__info">
          ...
          <div className="player__info__heart" ref={likeRef} onClick={handleLike}>
        ...
        <div className="player__control">
          <div className="player__control__btn">
            ...
            <i className="ri-rewind-fill" onClick={PrevIndex}></i>
            ...
            <i className="ri-speed-fill" onClick={NextIndex}></i>
