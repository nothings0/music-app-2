    ...
    <div className="album__right">
        {
            props.listRender?.map((item,index) => (
                <div className={`album__right__item ${song === item.encodeId ? 'active' : ''}`} key={index} onClick={() => handleClick(item.encodeId, item.title, item.artistsNames, item.thumbnail, index)}>
                    ...
                    <div className="album__right__item__right">
                        ...
                        <div className="album__right__item__right__txt"> 
                            <div className="album__right__item__right__txt__name">{item.title}</div>
                            <div className="album__right__item__right__txt__author">{item.artistsNames}</div>
                        </div>
                    </div>
